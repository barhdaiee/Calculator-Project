...
############################functions##################
##btn_click func continuously updates the input field whenever you enter a number
def btn_click(item):
    global expression
    expression = expression + str(item)
    input_text.set(expression)

##btn_clear func clears the input field
def btn_clear():
    global expression
    expression = ''
    input_text.set('')
...
##creating an input field in the frame
